...
export const TOOLS = [
    // ------------------------------------------------------------------ reads
    {
        ...
        description: "List or search agents in the on-chain IdentityRegistry (Algorand TestNet app 769444119). " +
    ...
    },
    {
        ...
        description: "Read an agent's score from the ReputationRegistry (Algorand TestNet app 769444120): payments " +
    ...
    },
    {
        ...
        description: "List jobs on the ValidationRegistry (Algorand TestNet app 769444121), newest first, " +
