...
import { resolveConfig, type RiparConfigInput } from "../config.js";
...
IdentityRegistry 768570170, ReputationRegistry 768570171, ValidationRegistry 768570174.
...
export function createRiparMcpServer(opts: CreateServerOptions = {}): McpServer {
  ...
  const ctx: ToolContext = { registry, config };
...
export async function startStdioServer(opts: CreateServerOptions = {}): Promise<McpServer> {
