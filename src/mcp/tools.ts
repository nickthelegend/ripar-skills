...
export const TOOLS: RiparToolSpec[] = [
  // ------------------------------------------------------------------ reads
  {
    ...
    description:
      "List or search agents in the on-chain IdentityRegistry (Algorand TestNet app 768633998). " +
...

  {
    ...
    description:
      "Read an agent's score from the ReputationRegistry (Algorand TestNet app 768633999): payments " +
...

  {
    ...
    description:
      "List jobs on the ValidationRegistry (Algorand TestNet app 768634000), newest first, " +
